...
public class JoinChannelPacket extends Packet
{
    ...
    private String passwordAttempt = ""; // we must have this here beacus we are sending the password for the channel over the internet with this packet. Ofc i can encode it but i don't see the point for the assignment
